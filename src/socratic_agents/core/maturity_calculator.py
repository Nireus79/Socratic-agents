...
from socratic_agents.core.insight_categorizer import InsightCategorizer
from socratic_agents.core.project_categories import get_phase_categories
from socratic_agents.models import CategoryScore, PhaseMaturity
