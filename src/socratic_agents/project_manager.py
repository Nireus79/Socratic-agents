...
from socratic_agents.models import VALID_ROLES, ProjectContext, TeamMemberRole
...
class ProjectManagerAgent(Agent):
    ...
    def _create_from_github(self, request: Dict) -> Dict:
        ...
        try:
            from socratic_agents.utils.git_repository_manager import GitRepositoryManager
